...
<head>
    ...
    <link rel="stylesheet" href="../CSS/sjb-login.css">
    <title>Log In | St. John Bosco Parish, Makati City, Philippines</title>
</head>
<body>
    <header>
    ...
    <section class="signin-section">
        <div class="signin-container">
            ...
            <div class="form-wrapper register-form-wrapper">
                <h2>Log In</h2>
                <form id="login-form" action="sjb-login.php" method="post">
                ...
                <p class="login-signup-text">
                    Don't have an account? <a href="../PHP/sjb-register.php" class="signup-link">Register here</a>
                </p>
            </div>
    ...
    document.getElementById('login-form').addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.includes("Error") || data.includes("error")) {
                ...
                window.location.href = "../PHP/sjb-admin.php";
            } else {
                alert("Login Successful!");
                window.location.href = "../HTML/sjb-home.html";
            }
        })
        .catch(error => {
            console.error(error);
